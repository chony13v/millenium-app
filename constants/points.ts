...
export const POINT_ACTIONS: PointAction[] = [
  ...
  },
  {
    ...
    points: getPointsForActivity("poll_vote"),
  ...
  },
  {
    ...
    points: getPointsForActivity("city_report_created"),
  ...
  },
  {
    ...
    points: getPointsForActivity("weekly_event_attendance"),
  ...
  },
  {
    ...
    points: getPointsForActivity("social_follow"),
  ...
  },
  {
    ...
    points: getPointsForActivity("referral_signup"),
  ...
  },
  {
    ...
    points: getPointsForActivity("streak_bonus"),
    frequency:
      "Se otorgan bonos por racha de 7, 14, 23 y 30 consecutivos, y después cada 30 días adicionales",
