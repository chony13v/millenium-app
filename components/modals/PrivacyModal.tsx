      ...
      <View style={{ 
        ...
        >
          ...
          <Text style={{ fontFamily: 'outfit-regular', marginBottom: 15, fontSize: 14, lineHeight: 20, color: '#000000' }}>
            Esta Política de Privacidad describe cómo [Nombre de la Empresa/Organización] recopila, utiliza y protege la información personal de los usuarios de nuestra aplicación móvil para el registro y participación en el torneo de fútbol.
          </Text>
          ...
          <Text style={{ fontFamily: 'outfit-regular', marginBottom: 15, fontSize: 14, lineHeight: 20, color: '#000000' }}>
            ...
            {'\n'}- Gestionar la inscripción y participación en el torneo
            {'\n'}- Comunicarnos con los padres o tutores sobre el evento
          ...
          <Text style={{ fontFamily: 'outfit-regular', marginBottom: 15, fontSize: 14, lineHeight: 20, color: '#000000' }}>
            ...
            {'\n'}Para ejercer estos derechos, por favor contacte a [información de contacto].
          </Text>
          ...
          <Text style={{ fontFamily: 'outfit-regular', marginBottom: 15, fontSize: 14, lineHeight: 20, color: '#000000' }}>
            Si tiene preguntas o inquietudes sobre esta Política de Privacidad, por favor contacte a
          </Text>
        </ScrollView>
