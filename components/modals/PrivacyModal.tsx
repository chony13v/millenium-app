    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Recopilamos la siguiente información personal de los participantes y
            ...
            {"\n"}- Datos de ubicación geográfica (cuando el usuario otorga
            permiso)
            {"\n"}- Acceso a la cámara para tomar fotos relacionadas con el
            perfil o actividades
          </Text>
          ...
          >
            ...
            {"\n"}- Usar la cámara para capturar imágenes requeridas por el
            programa
            {"\n"}- Obtener ubicación para mejorar la experiencia del usuario
            (ej. sugerencias por zona)
          </Text>
          ...
          >
            No compartimos la información personal con terceros, excepto cuando
            sea necesario para cumplir con la ley, proteger nuestros derechos, o
          ...
          >
            ...
            proteger la información personal contra el acceso no autorizado, la
          ...
          >
            De acuerdo con la legislación ecuatoriana, los usuarios tienen
            derecho a:
          ...
          >
            ...
            en cualquier momento. Notificaremos a los usuarios sobre cambios
            significativos a través de nuestra aplicación o por correo
            electrónico.
          </Text>
          ...
          >
            Podemos utilizar servicios de terceros como Google AdMob, Firebase o
            Google Analytics para mostrar publicidad y mejorar la funcionalidad
            de la aplicación. Estos servicios pueden recopilar información no
            personal como identificadores del dispositivo, tipo de sistema
            operativo y uso general de la app. No recopilamos datos para fines
          ...
          >
            Nuestra aplicación puede mostrar anuncios con el fin de financiar su
            mantenimiento y desarrollo. Trabajamos con redes de publicidad
            aprobadas que cumplen con los estándares de privacidad para
            adolescentes. En caso de utilizar publicidad personalizada,
            solicitaremos consentimiento explícito conforme a la legislación
            vigente.
          </Text>
